...
#Necessary to import MultiheadAttention that contains Gated Relative Position Bias (from WavLM)
from fairseq.modules import (
    MultiheadAttentionGRPB
)
...
#Define  ConvFeature ExtractionModel   and TransformerSentenceEncoderLayer as they were declared in UniSpeech
...
class TransformerSentenceEncoderLayer(nn.Module):
    ...
    def __init__(
        ...
        self.self_attn = MultiheadAttentionGRPB(
            self.embedding_dim,
            num_attention_heads,
